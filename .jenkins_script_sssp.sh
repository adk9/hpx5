...
mkdir build
cd build
../configure $CFGFLAGS --enable-pedantic --enable-wall --enable-apps --enable-jemalloc --disable-logging CFLAGS="-O3" $HPXDEBUG PKG_CONFIG_PATH=$HOME/tools/openmpi-1.8.3/lib/pkgconfig/:$PKG_CONFIG_PATH
make
