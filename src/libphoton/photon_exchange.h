...
// The ledger buffer is laid out as follows:
// | local_rcv | remote_rcv | local_snd | remote_snd | local_fin | remote_fin | local_eager | remote_eager | eager_bufs |
...
#define PHOTON_LE_PTR(a) (a + PHOTON_NP_INFO_SIZE * 4 + PHOTON_NP_LEDG_SIZE * 2)
#define PHOTON_RE_PTR(a) (a + PHOTON_NP_INFO_SIZE * 4 + PHOTON_NP_LEDG_SIZE * 3)
#define PHOTON_EB_PTR(a) (a + PHOTON_NP_INFO_SIZE * 4 + PHOTON_NP_LEDG_SIZE * 4)
