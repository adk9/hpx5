...
static dapl_buffer_t** registered_buffers=NULL;
static int buffertable_size;
static int num_registered_buffers;

static int buffertable_resize(int new_buffertable_size) {
	dapl_buffer_t** new_registered_buffer = realloc(registered_buffers,sizeof(dapl_buffer_t *)*new_buffertable_size);
