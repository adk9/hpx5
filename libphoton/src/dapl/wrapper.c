...
void photon_init_(int *np, int *rank, MPI_Comm comm, int *ret_val);
void photon_init__(int *np, int *rank, MPI_Comm comm, int *ret_val);
...
///////////////////////////////////////////////////////////////////////////////
FORTRAN(void,photon_init,(int *np, int *rank, MPI_Comm comm, int *ret_val) {
	*ret_val = photon_init(*np, *rank, comm);
	return;
})
