...
AC_DEFUN([HPX_CONTRIB_JEMALLOC],
  [$2jemalloc$3_cargs="$HPX_JEMALLOC_CARGS --disable-valgrind --disable-fill --disable-stats"
   ...
   hpx_jemalloc_libs="$hpx_jemalloc_libs -Wl,-rpath,\$(abs_top_builddir)/$1_build$3/lib,-ljemalloc$3"
   hpx_jemalloc_rpath="$hpx_jemalloc_rpath -rpath \$(abs_top_builddir)/$1_build$3/lib"
