...
#define BENCHMARK "Photon OS Get Bandwidth Test"
...
//****************************************************************************
// photon get bandwidth test
//****************************************************************************
START_TEST (test_photon_test_get_bw_bench) 
{
  ...
  fprintf(detailed_log, "Starting the photon get bandwidth benchmark test\n");
...
void add_photon_os_get_bw_bench(TCase *tc) {
  tcase_add_test(tc, test_photon_test_get_bw_bench);
}
