...
HPX_ACTION(HPX_DEFAULT, 0, _foo, _foo_action_handler); 
...
/*static HPX_ACTION(HPX_DEFAULT, 0, _hello, _main_action_handler);*/
...
int main(int argc, char *argv[argc]) {
  ...
  hpx_finalize();
  printf("1 finalize  got completed %d.\n", 1);
  return success;
}
