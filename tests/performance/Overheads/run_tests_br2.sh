...
aprun  -n 2 -N 1 -d 32 ./time_lco_allgather -c 16 -T 0 -s 4097 -p $((1024 * 1024 * 1024 * 50)) 10000
...
aprun  -n 2 -N 1 -d 32 ./time_lco_allreduce -c 16 -T 0 -s 4097 -p $((1024 * 1024 * 1024 * 50)) 10000
...
aprun  -n 2 -N 1 -d 32 ./time_lco_alltoall -c 16 -T 0 -s 4097 -p $((1024 * 1024* 1024 * 50)) 10000
