...
static int _doSomething_action(int *args, size_t size) {
  int ret1, ret2;
  int tid = *args;
...
int main(int argc, char *argv[]) {
  ...
  HPX_REGISTER_ACTION(HPX_DEFAULT, HPX_MARSHALLED, _doSomething, _doSomething_action, HPX_POINTER, HPX_SIZE_T);
