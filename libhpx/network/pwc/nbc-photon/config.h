...
/* Define to 1 if you have the `photon' library (-lphoton). */
#define HAVE_LIBPHOTON 1
...
/* enables the photon module */
#define HAVE_PHOTON 1
...
#define PACKAGE_STRING "libNBC 1.2"
