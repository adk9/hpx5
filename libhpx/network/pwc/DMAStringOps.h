...
#ifndef LIBHPX_NETWORK_PWC_DMA_STRING_OPS_H
#define LIBHPX_NETWORK_PWC_DMA_STRING_OPS_H
...
namespace network {
namespace pwc {
class DMAStringOps final : public StringOps {
 public:
 ...
 public:
  DMAStringOps(PWCNetwork& pwc, unsigned rank);
...
#endif // LIBHPX_NETWORK_PWC_DMA_STRING_OPS_H
