...
using libhpx::network::pwc::pwc_network;
...
int
libhpx::network::pwc::pwc_memcpy(void *obj, hpx_addr_t to, hpx_addr_t from,
                                 size_t n, hpx_addr_t sync)
{
...
int
libhpx::network::pwc::pwc_memcpy_sync(void *obj, hpx_addr_t to, hpx_addr_t from,
                                      size_t n)
{
