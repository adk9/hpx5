...
/// @returns            HPX_SUCCESS
static int
_parcel_memget_reply_handler(_parcel_memget_reply_args_t *args, size_t n)
{
...
static int
_parcel_memget_request_handler(const void *from, void *to, size_t n,
                               hpx_addr_t lsync)
{
  ...
  auto args = static_cast<_parcel_memget_reply_args_t *>(hpx_parcel_get_data(p));
  args->to = to;
...
static int
_parcel_memget(void *obj, void *to, hpx_addr_t from, size_t size,
...
/// read has completed.
static int
_parcel_memget_rsync(void *obj, void *to, hpx_addr_t from, size_t size,
                     hpx_addr_t lsync)
{
...
/// @returns            HPX_SUCCESS
static int
_parcel_memget_sync_handler(const void *from, size_t n)
{
...
static int
_parcel_memget_lsync(void *obj, void *to, hpx_addr_t from, size_t size)
{
...
/// @returns            HPX_SUCCESS
static int
_parcel_memput_request_handler(void *to, const void *from, size_t n)
{
  memcpy(to, from, n);
  return HPX_SUCCESS;
}
...
static int
_parcel_memput(void *obj, hpx_addr_t to, const void *from, size_t size,
               hpx_addr_t lsync, hpx_addr_t rsync)
{
...
static int
_parcel_memput_lsync(void *obj, hpx_addr_t to, const void *from, size_t size,
                     hpx_addr_t rsync)
{
  hpx_action_t  op = _parcel_memput_request;
  hpx_action_t set = hpx_lco_set_action;
...
static int
_parcel_memput_rsync(void *obj, hpx_addr_t to, const void *from, size_t size)
{
...
/// @returns            HPX_SUCCESS
static int
_parcel_memcpy_reply_handler(void *to, const void *data, size_t n)
{
  memcpy(to, data, n);
  return HPX_SUCCESS;
}
...
/// @returns            HPX_SUCCESS
static int
_parcel_memcpy_request_handler(const void *from, size_t n, hpx_addr_t to)
{
...
static int
_parcel_memcpy(void *obj, hpx_addr_t to, hpx_addr_t from, size_t n,
               hpx_addr_t rsync)
{
...
static int
_parcel_memcpy_sync(void *obj, hpx_addr_t to, hpx_addr_t from, size_t n)
{
