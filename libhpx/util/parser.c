...
const char *hpx_options_t_help[] = {
  ...
  "      --hpx-trace-classes=class filter by class  (possible values=\"parcel\",\n                                  \"network\", \"pwc\", \"sched\", \"lco\",\n                                  \"process\", \"memory\", \"schedtimes\",\n                                  \"file\", \"gas\", \"collective\", \"all\")",
...
const char *hpx_option_parser_hpx_trace_classes_values[] = {"parcel", "network", "pwc", "sched", "lco", "process", "memory", "schedtimes", "file", "gas", "collective", "all", 0}; /*< Possible values for hpx-trace-classes. */
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_coll_network_help = hpx_options_t_help[40] ;
  ...
  args_info->hpx_photon_fidev_help = hpx_options_t_help[50] ;
  args_info->hpx_photon_ledgersize_help = hpx_options_t_help[51] ;
  args_info->hpx_photon_pwcbufsize_help = hpx_options_t_help[52] ;
  ...
  args_info->hpx_parcel_compression_help = hpx_options_t_help[61] ;
  args_info->hpx_coalescing_buffersize_help = hpx_options_t_help[62] ;
