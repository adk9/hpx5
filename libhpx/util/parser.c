...
const char *hpx_option_parser_hpx_trace_classes_values[] = {"parcel", "network", "sched", "lco", "process", "memory", "schedtimes", "file", "gas", "collective", "all", 0}; /*< Possible values for hpx-trace-classes. */
