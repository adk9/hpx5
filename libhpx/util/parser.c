...
const char *hpx_options_t_help[] = {
  ...
  "      --hpx-sched=algorithm     the HPX scheduling algorithm  (possible\n                                  values=\"default\", \"workstealing\",\n                                  \"linden\")",
...
const char *hpx_option_parser_hpx_sched_values[] = {"default", "workstealing", "linden", 0}; /*< Possible values for hpx-sched. */
...
void clear_args (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_sched_arg = hpx_sched__NULL;
  args_info->hpx_sched_orig = NULL;
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_sched_help = hpx_options_t_help[14] ;
  ...
  args_info->hpx_progress_period_help = hpx_options_t_help[19] ;
  args_info->hpx_gas_affinity_help = hpx_options_t_help[21] ;
  args_info->hpx_log_at_help = hpx_options_t_help[23] ;
  args_info->hpx_log_at_min = 0;
  args_info->hpx_log_at_max = 0;
  args_info->hpx_log_level_help = hpx_options_t_help[24] ;
  args_info->hpx_log_level_min = 0;
  args_info->hpx_log_level_max = 0;
  args_info->hpx_dbg_waitat_help = hpx_options_t_help[26] ;
  args_info->hpx_dbg_waitat_min = 0;
  args_info->hpx_dbg_waitat_max = 0;
  args_info->hpx_dbg_waitonabort_help = hpx_options_t_help[27] ;
  args_info->hpx_dbg_waitonsig_help = hpx_options_t_help[28] ;
  args_info->hpx_dbg_waitonsig_min = 0;
  args_info->hpx_dbg_waitonsig_max = 0;
  args_info->hpx_dbg_mprotectstacks_help = hpx_options_t_help[29] ;
  args_info->hpx_dbg_syncfree_help = hpx_options_t_help[30] ;
  args_info->hpx_trace_backend_help = hpx_options_t_help[32] ;
  args_info->hpx_trace_at_help = hpx_options_t_help[33] ;
  args_info->hpx_trace_at_min = 0;
  args_info->hpx_trace_at_max = 0;
  args_info->hpx_trace_classes_help = hpx_options_t_help[34] ;
  args_info->hpx_trace_classes_min = 0;
  args_info->hpx_trace_classes_max = 0;
  args_info->hpx_trace_dir_help = hpx_options_t_help[35] ;
  args_info->hpx_trace_buffersize_help = hpx_options_t_help[36] ;
  args_info->hpx_trace_off_help = hpx_options_t_help[37] ;
  ...
  args_info->hpx_coll_network_help = hpx_options_t_help[46] ;
  args_info->hpx_photon_comporder_help = hpx_options_t_help[48] ;
  args_info->hpx_photon_backend_help = hpx_options_t_help[49] ;
  args_info->hpx_photon_coll_help = hpx_options_t_help[50] ;
  args_info->hpx_photon_ibdev_help = hpx_options_t_help[51] ;
  args_info->hpx_photon_ethdev_help = hpx_options_t_help[52] ;
  args_info->hpx_photon_ibport_help = hpx_options_t_help[53] ;
  args_info->hpx_photon_usecma_help = hpx_options_t_help[54] ;
  args_info->hpx_photon_ibsrq_help = hpx_options_t_help[55] ;
  args_info->hpx_photon_btethresh_help = hpx_options_t_help[56] ;
  args_info->hpx_photon_fiprov_help = hpx_options_t_help[57] ;
  args_info->hpx_photon_fidev_help = hpx_options_t_help[58] ;
  args_info->hpx_photon_ledgersize_help = hpx_options_t_help[59] ;
  args_info->hpx_photon_pwcbufsize_help = hpx_options_t_help[60] ;
  args_info->hpx_photon_eagerbufsize_help = hpx_options_t_help[61] ;
  args_info->hpx_photon_smallpwcsize_help = hpx_options_t_help[62] ;
  args_info->hpx_photon_maxrd_help = hpx_options_t_help[63] ;
  args_info->hpx_photon_defaultrd_help = hpx_options_t_help[64] ;
  args_info->hpx_photon_numcq_help = hpx_options_t_help[65] ;
  args_info->hpx_photon_usercq_help = hpx_options_t_help[66] ;
  args_info->hpx_opt_smp_help = hpx_options_t_help[68] ;
  args_info->hpx_parcel_compression_help = hpx_options_t_help[69] ;
  args_info->hpx_coalescing_buffersize_help = hpx_options_t_help[70] ;
...
hpx_option_parser_release (struct hpx_options_t *args_info)
{
  ...
  free_string_field (&(args_info->hpx_sched_orig));
...
hpx_option_parser_dump(FILE *outfile, struct hpx_options_t *args_info)
{
  ...
  if (args_info->hpx_sched_given)
    write_into_file(outfile, "hpx-sched", args_info->hpx_sched_orig, hpx_option_parser_hpx_sched_values);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* the HPX scheduling algorithm.  */
          else if (strcmp (long_options[option_index].name, "hpx-sched") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->hpx_sched_arg), 
                 &(args_info->hpx_sched_orig), &(args_info->hpx_sched_given),
                &(local_args_info.hpx_sched_given), optarg, hpx_option_parser_hpx_sched_values, 0, ARG_ENUM,
                check_ambiguity, override, 0, 0,
                "hpx-sched", '-',
                additional_error))
              goto failure;
