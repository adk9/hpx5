/*
  ...
  gengetopt --input=options.ggo --func-name=hpx_option_parser --arg-struct-name=hpx_options_t --file-name=parser --default-optional --string-parser --conf-parser --no-help --no-version --input=options.ggo --func-name=hpx_option_parser --arg-struct-name=hpx_options_t --file-name=parser --default-optional --string-parser --conf-parser --no-help --no-version
...
const char *hpx_option_parser_hpx_trace_classes_values[] = {"parcel", "pwc", "sched", "lco", "process", "memory", "schedtimes", "bookend", "all", 0}; /*< Possible values for hpx-trace-classes. */
const char *hpx_option_parser_hpx_prof_counters_values[] = {"L1_TCM", "L1_TCA", "L2_TCM", "L2_TCA", "L3_TCM", "L3_TCA", "TLB_TL", "TOT_INS", "INT_INS", "FP_INS", "LD_INS", "SR_INS", "BR_INS", "TOT_CYC", "all", 0}; /*< Possible values for hpx-prof-counters. */
