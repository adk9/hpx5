...
char *hpx_option_parser_hpx_log_level_values[] = {"default", "boot", "sched", "gas", "lco", "net", "trans", "parcel", "action", "all", 0} ;	/* Possible values for hpx-log-level.  */
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_sendlimit_help = hpx_options_t_help[13] ;
  args_info->hpx_recvlimit_help = hpx_options_t_help[14] ;
  args_info->hpx_configfile_help = hpx_options_t_help[15] ;
