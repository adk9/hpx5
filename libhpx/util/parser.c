...
const char *hpx_options_t_help[] = {
  ...
  "\nScheduler Options:",
  "      --hpx-cores=cores         number of scheduler cores (deprecated)",
  ...
  "      --hpx-log-level[=level,...]\n                                set the logging level  (possible \n                                  values=\"boot\", \"sched\", \"gas\", \"lco\", \n                                  \"net\", \"trans\", \"parcel\", \"action\", \n                                  \"config\", \"memory\", \"all\" \n                                  default=`all')",
  "\nHPX Debug Options:",
  ...
  "      --hpx-prof-event=event    set which event to profile  (possible \n                                  values=\"none\")",
  "      --hpx-prof-action=action  set which action to profile",
...
char *hpx_option_parser_hpx_gas_values[] = {"default", "smp", "pgas", "agas", 0} ;	/* Possible values for hpx-gas.  */
...
char *hpx_option_parser_hpx_log_level_values[] = {"boot", "sched", "gas", "lco", "net", "trans", "parcel", "action", "config", "memory", "all", 0} ;	/* Possible values for hpx-log-level.  */
char *hpx_option_parser_hpx_dbg_waitonsig_values[] = {"segv", "abrt", "fpe", "ill", "bus", "iot", "sys", "trap", "all", 0} ;	/* Possible values for hpx-dbg-waitonsig.  */
char *hpx_option_parser_hpx_trace_classes_values[] = {"parcel", "pwc", "sched", "lco", "process", "memory", "schedtimes", "all", 0} ;	/* Possible values for hpx-trace-classes.  */
char *hpx_option_parser_hpx_prof_counters_values[] = {"HPX_L1_TCM", "HPX_L2_TCM", "HPX_L3_TCM", "HPX_TLB_TL", "HPX_TOT_INS", "HPX_INT_INS", "HPX_FP_INS", "HPX_LD_INS", "HPX_SR_INS", "HPX_BR_INS", "HPX_TOT_CYC", "all", 0} ;	/* Possible values for hpx-prof-counters.  */
char *hpx_option_parser_hpx_prof_event_values[] = {"none", 0} ;	/* Possible values for hpx-prof-event.  */
char *hpx_option_parser_hpx_photon_backend_values[] = {"default", "verbs", "ugni", "fi", 0} ;	/* Possible values for hpx-photon-backend.  */
...
void clear_given (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_prof_event_given = 0 ;
  args_info->hpx_prof_action_given = 0 ;
...
void clear_args (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_prof_event_arg = -1;
  args_info->hpx_prof_event_orig = NULL;
  args_info->hpx_prof_action_arg = NULL;
  args_info->hpx_prof_action_orig = NULL;
  ...
  args_info->hpx_photon_backend_arg = -1;
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_dbg_waitonsig_min = -1;
  args_info->hpx_dbg_waitonsig_max = -1;
  ...
  args_info->hpx_inst_at_min = -1;
  args_info->hpx_inst_at_max = -1;
  ...
  args_info->hpx_prof_counters_min = -1;
  args_info->hpx_prof_counters_max = -1;
  args_info->hpx_prof_event_help = hpx_options_t_help[34] ;
  args_info->hpx_prof_action_help = hpx_options_t_help[35] ;
...
hpx_option_parser_release (struct hpx_options_t *args_info)
{
  ...
  free_string_field (&(args_info->hpx_prof_event_orig));
  free_string_field (&(args_info->hpx_prof_action_arg));
  free_string_field (&(args_info->hpx_prof_action_orig));
...
hpx_option_parser_dump(FILE *outfile, struct hpx_options_t *args_info)
{
  ...
  if (args_info->hpx_prof_event_given)
    write_into_file(outfile, "hpx-prof-event", args_info->hpx_prof_event_orig, hpx_option_parser_hpx_prof_event_values);
  if (args_info->hpx_prof_action_given)
    write_into_file(outfile, "hpx-prof-action", args_info->hpx_prof_action_orig, 0);
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "hpx-prof-event",	1, NULL, 0 },
        { "hpx-prof-action",	1, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          /* number of scheduler cores (deprecated).  */
          ...
          /* set which event to profile.  */
          else if (strcmp (long_options[option_index].name, "hpx-prof-event") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->hpx_prof_event_arg), 
                 &(args_info->hpx_prof_event_orig), &(args_info->hpx_prof_event_given),
                &(local_args_info.hpx_prof_event_given), optarg, hpx_option_parser_hpx_prof_event_values, 0, ARG_ENUM,
                check_ambiguity, override, 0, 0,
                "hpx-prof-event", '-',
                additional_error))
              goto failure;
          ...
          /* set which action to profile.  */
          else if (strcmp (long_options[option_index].name, "hpx-prof-action") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->hpx_prof_action_arg), 
                 &(args_info->hpx_prof_action_orig), &(args_info->hpx_prof_action_given),
                &(local_args_info.hpx_prof_action_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "hpx-prof-action", '-',
                additional_error))
              goto failure;
