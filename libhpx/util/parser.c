...
const char *hpx_option_parser_hpx_prof_event_values[] = {"none", 0}; /*< Possible values for hpx-prof-event. */
...
void clear_args (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_prof_event_arg = hpx_prof_event__NULL;
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "hpx-log-level") == 0)
          {
            ...
            if (update_multiple_arg_temp(&hpx_log_level_list, 
                &(local_args_info.hpx_log_level_given), optarg, hpx_option_parser_hpx_log_level_values, 0, ARG_ENUM,
                "hpx-log-level", '-',
                additional_error))
              goto failure;
