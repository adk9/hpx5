...
const char *hpx_option_parser_hpx_gas_affinity_values[] = {"none", "urcu", 0}; /*< Possible values for hpx-gas-affinity. */
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_gas_affinity_help = hpx_options_t_help[18] ;
  ...
  args_info->hpx_trace_backend_help = hpx_options_t_help[29] ;
