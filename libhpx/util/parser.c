...
const char *hpx_options_t_help[] = {
  ...
  "      --hpx-coalescing-enabled  Enable coalescing  (default=off)",
  "      --hpx-coalescing-buffersize=coalescing_size\n                                Coalescing buffer size",
...
void clear_given (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_coalescing_enabled_given = 0 ;
...
void clear_args (struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_coalescing_enabled_flag = 0;
...
void init_args_info(struct hpx_options_t *args_info)
{
  ...
  args_info->hpx_coalescing_enabled_help = hpx_options_t_help[7] ;
  args_info->hpx_coalescing_buffersize_help = hpx_options_t_help[8] ;
  ...
  args_info->hpx_configfile_help = hpx_options_t_help[12] ;
  args_info->hpx_threads_help = hpx_options_t_help[14] ;
  args_info->hpx_thread_affinity_help = hpx_options_t_help[15] ;
  args_info->hpx_stacksize_help = hpx_options_t_help[16] ;
  args_info->hpx_sched_policy_help = hpx_options_t_help[17] ;
  args_info->hpx_sched_wfthreshold_help = hpx_options_t_help[18] ;
  args_info->hpx_sched_stackcachelimit_help = hpx_options_t_help[19] ;
  args_info->hpx_log_at_help = hpx_options_t_help[21] ;
  args_info->hpx_log_at_min = 0;
  args_info->hpx_log_at_max = 0;
  args_info->hpx_log_level_help = hpx_options_t_help[22] ;
  args_info->hpx_log_level_min = 0;
  args_info->hpx_log_level_max = 0;
  args_info->hpx_dbg_waitat_help = hpx_options_t_help[24] ;
  args_info->hpx_dbg_waitat_min = 0;
  args_info->hpx_dbg_waitat_max = 0;
  args_info->hpx_dbg_waitonabort_help = hpx_options_t_help[25] ;
  args_info->hpx_dbg_waitonsig_help = hpx_options_t_help[26] ;
  args_info->hpx_dbg_waitonsig_min = 0;
  args_info->hpx_dbg_waitonsig_max = 0;
  args_info->hpx_dbg_mprotectstacks_help = hpx_options_t_help[27] ;
  args_info->hpx_dbg_syncfree_help = hpx_options_t_help[28] ;
  args_info->hpx_inst_dir_help = hpx_options_t_help[30] ;
  args_info->hpx_inst_at_help = hpx_options_t_help[31] ;
  ...
  args_info->hpx_trace_filesize_help = hpx_options_t_help[34] ;
  args_info->hpx_prof_counters_help = hpx_options_t_help[36] ;
  args_info->hpx_prof_counters_min = 0;
  args_info->hpx_prof_counters_max = 0;
  args_info->hpx_prof_detailed_help = hpx_options_t_help[37] ;
  args_info->hpx_isir_testwindow_help = hpx_options_t_help[39] ;
  args_info->hpx_isir_sendlimit_help = hpx_options_t_help[40] ;
  args_info->hpx_isir_recvlimit_help = hpx_options_t_help[41] ;
  args_info->hpx_pwc_parcelbuffersize_help = hpx_options_t_help[43] ;
  args_info->hpx_pwc_parceleagerlimit_help = hpx_options_t_help[44] ;
...
hpx_option_parser_dump(FILE *outfile, struct hpx_options_t *args_info)
{
  ...
  if (args_info->hpx_coalescing_enabled_given)
    write_into_file(outfile, "hpx-coalescing-enabled", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "hpx-gas",	1, NULL, 0 },
        { "hpx-boot",	1, NULL, 0 },
        { "hpx-coalescing-enabled",	0, NULL, 0 },
