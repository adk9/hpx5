...
enum enum_hpx_transport { hpx_transport_arg_default = 0 , hpx_transport_arg_mpi, hpx_transport_arg_photon };
enum enum_hpx_network { hpx_network_arg_default = 0 , hpx_network_arg_smp, hpx_network_arg_pwc, hpx_network_arg_isir };
enum enum_hpx_log_level { hpx_log_level_arg_boot = 0 , hpx_log_level_arg_sched, hpx_log_level_arg_gas, hpx_log_level_arg_lco, hpx_log_level_arg_net, hpx_log_level_arg_trans, hpx_log_level_arg_parcel, hpx_log_level_arg_action, hpx_log_level_arg_config, hpx_log_level_arg_memory, hpx_log_level_arg_all };
enum enum_hpx_dbg_waitonsig { hpx_dbg_waitonsig_arg_segv = 0 , hpx_dbg_waitonsig_arg_abrt, hpx_dbg_waitonsig_arg_fpe, hpx_dbg_waitonsig_arg_ill, hpx_dbg_waitonsig_arg_bus, hpx_dbg_waitonsig_arg_iot, hpx_dbg_waitonsig_arg_sys, hpx_dbg_waitonsig_arg_trap, hpx_dbg_waitonsig_arg_all };
enum enum_hpx_trace_classes { hpx_trace_classes_arg_parcel = 0 , hpx_trace_classes_arg_pwc, hpx_trace_classes_arg_sched, hpx_trace_classes_arg_lco, hpx_trace_classes_arg_process, hpx_trace_classes_arg_memory, hpx_trace_classes_arg_schedtimes, hpx_trace_classes_arg_all };
enum enum_hpx_prof_counters { hpx_prof_counters_arg_HPX_L1_TCM = 0 , hpx_prof_counters_arg_HPX_L2_TCM, hpx_prof_counters_arg_HPX_L3_TCM, hpx_prof_counters_arg_HPX_TLB_TL, hpx_prof_counters_arg_HPX_TOT_INS, hpx_prof_counters_arg_HPX_INT_INS, hpx_prof_counters_arg_HPX_FP_INS, hpx_prof_counters_arg_HPX_LD_INS, hpx_prof_counters_arg_HPX_SR_INS, hpx_prof_counters_arg_HPX_BR_INS, hpx_prof_counters_arg_HPX_TOT_CYC, hpx_prof_counters_arg_all };
enum enum_hpx_prof_event { hpx_prof_event_arg_none = 0  };
enum enum_hpx_photon_backend { hpx_photon_backend_arg_default = 0 , hpx_photon_backend_arg_verbs, hpx_photon_backend_arg_ugni, hpx_photon_backend_arg_fi };
...
struct hpx_options_t
{
  ...
  int hpx_dbg_waitonsig_min; /**< @brief wait on program error signals's minimum occurreces */
  int hpx_dbg_waitonsig_max; /**< @brief wait on program error signals's maximum occurreces */
  ...
  int hpx_inst_at_min; /**< @brief set the localities to activate instrumentation at's minimum occurreces */
  int hpx_inst_at_max; /**< @brief set the localities to activate instrumentation at's maximum occurreces */
  ...
  int hpx_prof_counters_min; /**< @brief set which PAPI counters to use for profiling's minimum occurreces */
  int hpx_prof_counters_max; /**< @brief set which PAPI counters to use for profiling's maximum occurreces */
  const char *hpx_prof_counters_help; /**< @brief set which PAPI counters to use for profiling help description.  */
  enum enum_hpx_prof_event hpx_prof_event_arg;	/**< @brief set which event to profile.  */
  char * hpx_prof_event_orig;	/**< @brief set which event to profile original value given at command line.  */
  const char *hpx_prof_event_help; /**< @brief set which event to profile help description.  */
  char * hpx_prof_action_arg;	/**< @brief set which action to profile.  */
  char * hpx_prof_action_orig;	/**< @brief set which action to profile original value given at command line.  */
  const char *hpx_prof_action_help; /**< @brief set which action to profile help description.  */
  ...
  unsigned int hpx_prof_action_given ;	/**< @brief Whether hpx-prof-action was given.  */
...
extern char *hpx_option_parser_hpx_dbg_waitonsig_values[] ;	/**< @brief Possible values for hpx-dbg-waitonsig.  */
extern char *hpx_option_parser_hpx_trace_classes_values[] ;	/**< @brief Possible values for hpx-trace-classes.  */
extern char *hpx_option_parser_hpx_prof_counters_values[] ;	/**< @brief Possible values for hpx-prof-counters.  */
extern char *hpx_option_parser_hpx_prof_event_values[] ;	/**< @brief Possible values for hpx-prof-event.  */
