...
#define     HPX_INST_CLASS_BOOKEND INT32_C(7)
#define       HPX_INST_NUM_CLASSES INT32_C(8)
...
#define     HPX_INST_EVENT_SCHED_WQSIZE INT32_C(10)
#define  HPX_INST_EVENT_SCHED_PUSH_LIFO INT32_C(11)
#define   HPX_INST_EVENT_SCHED_POP_LIFO INT32_C(12)
#define HPX_INST_EVENT_SCHED_STEAL_LIFO INT32_C(13)
#define      HPX_INST_EVENT_SCHED_ENTER INT32_C(14)
#define       HPX_INST_EVENT_SCHED_EXIT INT32_C(15)

#define          HPX_INST_EVENT_LCO_INIT INT32_C(16)
#define        HPX_INST_EVENT_LCO_DELETE INT32_C(17)
#define           HPX_INST_EVENT_LCO_SET INT32_C(18)
#define         HPX_INST_EVENT_LCO_RESET INT32_C(19)
#define HPX_INST_EVENT_LCO_ATTACH_PARCEL INT32_C(20)
#define          HPX_INST_EVENT_LCO_WAIT INT32_C(21)
#define       HPX_INST_EVENT_LCO_TRIGGER INT32_C(22)

#define    HPX_INST_EVENT_PROCESS_NEW INT32_C(23)
#define   HPX_INST_EVENT_PROCESS_CALL INT32_C(24)
#define HPX_INST_EVENT_PROCESS_DELETE INT32_C(25)

#define HPX_INST_EVENT_MEMORY_REGISTERED_ALLOC INT32_C(26)
#define  HPX_INST_EVENT_MEMORY_REGISTERED_FREE INT32_C(27)
#define     HPX_INST_EVENT_MEMORY_GLOBAL_ALLOC INT32_C(28)
#define      HPX_INST_EVENT_MEMORY_GLOBAL_FREE INT32_C(29)
#define     HPX_INST_EVENT_MEMORY_CYCLIC_ALLOC INT32_C(30)
#define      HPX_INST_EVENT_MEMORY_CYCLIC_FREE INT32_C(31)
#define HPX_INST_EVENT_MEMORY_ENTER_ALLOC_FREE INT32_C(32)

#define              HPX_INST_SCHEDTIMES_SCHED INT32_C(33)
#define              HPX_INST_SCHEDTIMES_PROBE INT32_C(34)
#define           HPX_INST_SCHEDTIMES_PROGRESS INT32_C(35)

#define                       HPX_INST_BOOKEND INT32_C(36)
#define                    HPX_INST_NUM_EVENTS INT32_C(37)
