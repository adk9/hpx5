...
/// @struct worker_t
/// @var worker_t::thread
/// this worker's native thread
/// @var worker_t::id
/// this worker's id
/// @var worker_t::seed
/// my random seed
/// @var worker_t::work_first
/// this worker's mode
/// @var worker_t::nstacks
/// count of freelisted stacks
/// @var worker_t::yielded
/// used by APEX
/// @var worker_t::active
/// used by APEX scheduler throttling
/// @var worker_t::system
/// this worker's native parcel
/// @var worker_t::current
/// current thread
/// @var worker_t::stacks
/// freelisted stacks
/// @var worker_t::work_id
/// which queue are we using
/// @var worker_t::queues
/// @var worker_t::inbox
/// mail sent to me
/// @var worker_t::stats
/// per-worker statistics
/// @var worker_t::last_victim
/// last successful victim
/// @var worker_t::numa_node
/// this worker's numa node
/// @var worker_t::profiler
