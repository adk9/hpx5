...
HPX_INTERNAL btt_class_t *btt_local_only_new(size_t heap_size, size_t btt_size);
HPX_INTERNAL btt_class_t *btt_pgas_new(size_t heap_size, size_t btt_size);
HPX_INTERNAL btt_class_t *btt_agas_new(size_t heap_size, size_t btt_size);
HPX_INTERNAL btt_class_t *btt_agas_switch_new(size_t heap_size, size_t btt_size);
HPX_INTERNAL btt_class_t *btt_new(hpx_gas_t type, size_t heap_size, size_t btt_size);
