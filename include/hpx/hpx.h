...
hpx_addr_t hpx_future_array_new(int n, int size, int block_size);
hpx_addr_t hpx_future_array_at(hpx_addr_t base, int i);
void hpx_future_array_delete(hpx_addr_t array);
