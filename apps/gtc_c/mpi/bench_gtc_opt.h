...
/* load the particles uniform in the radial dimension */
#define UNIFORM_PARTICLE_LOADING  1
...
/* for full-f simulation
   FULL_F_TYPE=0: rhs of Poisson equation is n_i - <n_i>
   FULL_F_TYPE=1: rhs of Possson equation is n_i - n0_i - (<n_i> - <n0_i>)
*/
#define FULL_F_TYPE         0
...
*/
#define NORMAL_LOADING          1

/* flat backgroup profile */
#define FLAT_PROFILE            0
