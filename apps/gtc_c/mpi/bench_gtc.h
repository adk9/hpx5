...
extern real poisson_fixghost_t;
...
typedef struct {
    ...
    real *rtemi;  // Ti_0(r)
    real *rden;   // n_0(r)
    real *kapati; // dTi_0(r)/Ti_0(r)
    real *kapan; // dn_0(r)/n_0(r)
    real *qtinv;  // q factor
    real *pmarki; // marker weights on flux surfaces
    real *zonali;
    real *zonali0;
    real *gradt;
    real *difft;
...
int pushi_noloopfusion(gtc_bench_data_t*);
...
int load(gtc_bench_data_t *);
int radial_profile(gtc_bench_data_t *);
